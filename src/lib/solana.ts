...
// Default RPC endpoint (Solana Mainnet) - using public endpoint
// For production, use a dedicated RPC from Helius, QuickNode, or Alchemy
  ...
  try {
    ...
    try {
      ...
      return {
        signature: '',
        success: false,
        error: 'Recipient does not have an associated token account for this token.',
      };
    }
